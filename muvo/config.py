...
_C.MODEL.TRANSFORMER_TRANSITION = CN()
_C.MODEL.TRANSFORMER_TRANSITION.ENABLED = True
...
_C.LOSSES.PERCEPTUAL = CN()
_C.LOSSES.PERCEPTUAL.ENABLED = False
_C.LOSSES.PERCEPTUAL.MODEL = 'resnet18'
